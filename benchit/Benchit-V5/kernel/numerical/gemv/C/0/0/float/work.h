...
void ij_(int sizeVector,int sizeAusgabe,float alpha,float beta, float* a, float *x, float *y);
void ji_(int sizeVector,int sizeAusgabe,float alpha,float beta, float* a, float *x, float *y);
