...
void ssealignIJ_(int sizeVector,int sizeAusgabe,double alpha,double beta, double* a, double *x, double *y);
void ssealignJI_(int sizeVector,int sizeAusgabe,double alpha,double beta, double* a, double *x, double *y);
...
gemv, double precision sse aligned
