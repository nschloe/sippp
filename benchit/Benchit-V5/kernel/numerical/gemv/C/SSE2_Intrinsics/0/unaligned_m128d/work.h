...
void sseunalignIJ_(int sizeVector,int sizeAusgabe,double alpha,double beta, double* a, double *x, double *y);
void sseunalignJI_(int sizeVector,int sizeAusgabe,double alpha,double beta, double* a, double *x, double *y);
