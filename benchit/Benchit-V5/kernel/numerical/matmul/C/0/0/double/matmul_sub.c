...
void bi_getinfo( bi_info* infostruct )
{
  ...
  infostruct->kerneldescription = bi_strdup( "Matrix Multiply (C)" );
...
$Log: matmul_sub.c,v $
Revision 1.11  2006/05/09 09:33:29  rschoene
removed bug: count_ delivered an unsigned long, which isn't long enough,
changed to double

Revision 1.10  2006/01/03 15:11:34  mickler
# Changes for error output

Revision 1.9  2005/12/15 09:28:29  hackenb
new variable names
modified/unified header and footer
MIN/MAX/INCREMENT iterating strategy

Revision 1.8  2005/11/29 10:52:40  mickler
- Fixed // comment
# Removed unnecessary variables

Revision 1.7  2005/11/22 01:26:52  mickler
+ Using BI_GET_CALL_OVERHEAD_FUNC macro now
+ Using bi_timer() function for time measuring

Revision 1.6  2005/10/25 12:05:47  william
fixed the axis-bug bugtracker-nr #87

Revision 1.5  2005/08/24 11:15:45  rschoene
outlier direction for FLOPS is 0 !!!!!
...
update f�Sr interface.h und f�Sr sch�Snheit
