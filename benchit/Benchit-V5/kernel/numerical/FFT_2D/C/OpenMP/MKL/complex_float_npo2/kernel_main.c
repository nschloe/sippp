 ...
 *          single precision, complex data, MKL (C), OpenMP version
...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->kerneldescription = bi_strdup("2D Fast Fourier Transform, Non-Powers of 2, single precision, complex data, MKL (C), OpenMP version");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* create FFT plan */
   status = DftiCreateDescriptor(&pmydata->my_desc_handle, DFTI_SINGLE, DFTI_COMPLEX, 2, len);
