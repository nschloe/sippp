...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->kerneldescription = bi_strdup("2D Fast Fourier Transform, Non-Powers of 2, single precision, complex data, FFTW3 (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->inout = (fftwf_complex*)fftwf_malloc(sizeof(fftwf_complex) * imyproblemsize * imyproblemsize);

   /* create FFT plan */
   pmydata->p = fftwf_plan_dft_2d(imyproblemsize, imyproblemsize, pmydata->inout, pmydata->inout, FFTW_FORWARD, FFTW_ESTIMATE);
   ...
   /* malloc */
   pmydata->in = (fftwf_complex*)fftwf_malloc(sizeof(fftwf_complex) * imyproblemsize * imyproblemsize);
   pmydata->out = (fftwf_complex*)fftwf_malloc(sizeof(fftwf_complex) * imyproblemsize * imyproblemsize);

   /* create FFT plan */
   pmydata->p = fftwf_plan_dft_2d(imyproblemsize, imyproblemsize, pmydata->in, pmydata->out, FFTW_FORWARD, FFTW_ESTIMATE);
