...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->codesequence = bi_strdup("zfft2dx");
   pinfo->kerneldescription = bi_strdup("2D Fast Fourier Transform, Non-Powers of 2, double precision, complex data, ACML (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->comm = (double*)malloc(sizeof(double) * 2 * (imyproblemsize * imyproblemsize + 5 * 2 * imyproblemsize + 200));
   pmydata->inout = (double*)malloc(sizeof(double) * imyproblemsize * imyproblemsize * 2);

   /* create FFT plan */
   zfft2dx(0, 1.0, 1, 1, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->inout, 1, imyproblemsize, (doublecomplex *)pmydata->inout, 1, imyproblemsize, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft2dx(-1, 1.0, 1, 1, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->inout, 1, imyproblemsize, (doublecomplex *)pmydata->inout, 1, imyproblemsize, (doublecomplex *)pmydata->comm, &info);
   ...
   /* create FFT plan */
   zfft2dx(0, 1.0, 1, 0, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->in, 1, imyproblemsize, (doublecomplex *)pmydata->out, 1, imyproblemsize, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft2dx(-1, 1.0, 1, 0, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->in, 1, imyproblemsize, (doublecomplex *)pmydata->out, 1, imyproblemsize, (doublecomplex *)pmydata->comm, &info);
