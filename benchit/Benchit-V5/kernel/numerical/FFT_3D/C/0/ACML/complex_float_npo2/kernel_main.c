...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->codesequence = bi_strdup("cfft3dx");
   pinfo->kerneldescription = bi_strdup("3D Fast Fourier Transform, Non-Powers of 2, single precision, complex data, ACML (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->comm = (float*)malloc(sizeof(float) * 2 * (imyproblemsize * imyproblemsize * imyproblemsize + 5 * 3 * imyproblemsize + 300));
   pmydata->inout = (float*)malloc(sizeof(float) * imyproblemsize * imyproblemsize * imyproblemsize * 2);

   /* create FFT plan */
   cfft3dx(0, 1.0, 1, 1, imyproblemsize, imyproblemsize, imyproblemsize, (complex *)pmydata->inout, (complex *)pmydata->inout, (complex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   cfft3dx(-1, 1.0, 1, 1, imyproblemsize, imyproblemsize, imyproblemsize, (complex *)pmydata->inout, (complex *)pmydata->inout, (complex *)pmydata->comm, &info);
   ...
   /* create FFT plan */
   cfft3dx(0, 1.0, 1, 0, imyproblemsize, imyproblemsize, imyproblemsize, (complex *)pmydata->in, (complex *)pmydata->out, (complex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   cfft3dx(-1, 1.0, 1, 0, imyproblemsize, imyproblemsize, imyproblemsize, (complex *)pmydata->in, (complex *)pmydata->out, (complex *)pmydata->comm, &info);
