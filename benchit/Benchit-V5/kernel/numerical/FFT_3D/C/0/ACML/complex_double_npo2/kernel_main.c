...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->codesequence = bi_strdup("zfft3dx");
   pinfo->kerneldescription = bi_strdup("3D Fast Fourier Transform, Non-Powers of 2, double precision, complex data, ACML (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->comm = (double*)malloc(sizeof(double) * 2 * (imyproblemsize * imyproblemsize * imyproblemsize + 5 * 3 * imyproblemsize + 300));
   pmydata->inout = (double*)malloc(sizeof(double) * imyproblemsize * imyproblemsize * imyproblemsize * 2);

   /* create FFT plan */
   zfft3dx(0, 1.0, 1, 1, imyproblemsize, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->inout, (doublecomplex *)pmydata->inout, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft3dx(-1, 1.0, 1, 1, imyproblemsize, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->inout, (doublecomplex *)pmydata->inout, (doublecomplex *)pmydata->comm, &info);
   ...
   /* create FFT plan */
   zfft3dx(0, 1.0, 1, 0, imyproblemsize, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->in, (doublecomplex *)pmydata->out, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft3dx(-1, 1.0, 1, 0, imyproblemsize, imyproblemsize, imyproblemsize, (doublecomplex *)pmydata->in, (doublecomplex *)pmydata->out, (doublecomplex *)pmydata->comm, &info);
