...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->codesequence = bi_strdup("cfft1dx");
   pinfo->kerneldescription = bi_strdup("1D Fast Fourier Transform, Non-Powers of 2, single precision, complex data, ACML (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->comm = (float*)malloc(sizeof(float) * 2 * (5 * imyproblemsize + 100));
   pmydata->inout = (float*)malloc(sizeof(float) * imyproblemsize * 2);

   /* create FFT plan */
   cfft1dx(0, 1.0, 1, imyproblemsize, (complex *)pmydata->inout, 1, (complex *)pmydata->inout, 1, (complex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   cfft1dx(-1, 1.0, 1, imyproblemsize, (complex *)pmydata->inout, 1, (complex *)pmydata->inout, 1, (complex *)pmydata->comm, &info);
   ...
   /* create FFT plan */
   cfft1dx(0, 1.0, 0, imyproblemsize, (complex *)pmydata->in, 1, (complex *)pmydata->out, 1, (complex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   cfft1dx(-1, 1.0, 0, imyproblemsize, (complex *)pmydata->in, 1, (complex *)pmydata->out, 1, (complex *)pmydata->comm, &info);
