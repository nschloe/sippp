...
void bi_getinfo(bi_info* pinfo)
{
   ...
   pinfo->codesequence = bi_strdup("zfft1dx");
   pinfo->kerneldescription = bi_strdup("1D Fast Fourier Transform, Non-Powers of 2, double precision, complex data, ACML (C)");
...
int bi_entry(void * mdpv, int iproblemsize, double * dresults)
{
   ...
   /* malloc */
   pmydata->comm = (double*)malloc(sizeof(double) * 2 * (5 * imyproblemsize + 100));
   pmydata->inout = (double*)malloc(sizeof(double) * imyproblemsize * 2);

   /* create FFT plan */
   zfft1dx(0, 1.0, 1, imyproblemsize, (doublecomplex *)pmydata->inout, 1, (doublecomplex *)pmydata->inout, 1, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft1dx(-1, 1.0, 1, imyproblemsize, (doublecomplex *)pmydata->inout, 1, (doublecomplex *)pmydata->inout, 1, (doublecomplex *)pmydata->comm, &info);
   ...
   /* malloc */
   pmydata->comm = (double*)malloc(sizeof(double) * 2 * (5 * imyproblemsize + 100));
   pmydata->in = (double*)malloc(sizeof(double) * imyproblemsize * 2);
   pmydata->out = (double*)malloc(sizeof(double) * imyproblemsize * 2);

   /* create FFT plan */
   zfft1dx(0, 1.0, 0, imyproblemsize, (doublecomplex *)pmydata->in, 1, (doublecomplex *)pmydata->out, 1, (doublecomplex *)pmydata->comm, &info);
   ...
   dstart = bi_gettime();
   /* fft calculation */
   zfft1dx(-1, 1.0, 0, imyproblemsize, (doublecomplex *)pmydata->in, 1, (doublecomplex *)pmydata->out, 1, (doublecomplex *)pmydata->comm, &info);
