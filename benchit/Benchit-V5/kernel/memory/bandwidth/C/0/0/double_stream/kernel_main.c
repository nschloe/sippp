...
void bi_getinfo( bi_info * infostruct )
{
  char buf[200];
   ...
   sprintf(buf,"STREAM inspired benchmark (F77)#"
               "OFFSET=%i#"
               " NTIMES=%i",offset,internal_repeats);
 ...
 *
 * Revision 1.3  2007/02/13 13:03:46  rschoene
 * changed parameters for work-calls
 *
 * Revision 1.2  2007/02/13 12:56:37  rschoene
