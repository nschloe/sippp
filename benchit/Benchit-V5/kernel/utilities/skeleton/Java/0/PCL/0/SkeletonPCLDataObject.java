...
*  this file: a container class for the data
*
*  Author: Robert Wloch (wloch@zhr.tu-dresden.de)
*  Last change by: $Author: wloch $
*  $Revision: 1.1.1.1 $
*  $Date: 2005/07/18 13:03:21 $
*
******************************************************************************/

public class SkeletonPCLDataObject {
	// data to be processed
/*
	public double[] a = null;
*/
	public SkeletonPCLDataObject() {
	}
}
/******************************************************************************
*  Log-History
*
*  $Log: SkeletonPCLDataObject.java,v $
